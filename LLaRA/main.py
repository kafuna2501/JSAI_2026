...
def main(args):
    ...
    if args.mode == 'train':
        ...
        if torch.cuda.is_available():
          ...
          print(f"[GPU MEM] peak allocated: {peak_alloc:.2f} GB")
          print(f"[GPU MEM] peak reserved : {peak_reserved:.2f} GB")
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='retail_data', type=str)
    parser.add_argument('--data_dir', default='content/drive/MyDrive/Uozumi/JSAI_2026/data/ref/retail', type=str)
    ...
    parser.add_argument('--ckpt_dir', default='/content/drive/MyDrive/Uozumi/checkpoints/checkpoints_100>=3_tmp=0.5', type=str)
    parser.add_argument('--log_dir', default='retail_logs', type=str)

    parser.add_argument('--rec_size', default=64, type=int)
    parser.add_argument('--padding_item_id', default=793, type=int)
    ...
    parser.add_argument('--cans_num', default=792, type=int)
    ...
    elif 'retail' in args.data_dir:
        args.padding_item_id = 793
